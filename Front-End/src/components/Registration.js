...
const Registration = () => {
  ...
  const HandleRegistration = () => {
    ...
    axios.post('http://localhost:8080/registration', regData,{headers: {'Content-Type': 'application/json',}}  )
      ...
      return (
        <section className="vh bg-image" style={{ backgroundImage: "url('backgroundImage.jpg')" }}>
                    ...
                    <div className="card-body p-5">
                      ...
                      <form>
                        ...
                        <div className="form-outline mb-4">
                          <input type="text" id="firstName" className="form-control form-control-lg" onChange={handleData} />
                          <label className="form-label" htmlFor="firstName">First Name</label>
                        </div>
                        <div className="form-outline mb-4">
                          <input type="text" id="lastName" className="form-control form-control-lg" onChange={handleData} />
                          <label className="form-label" htmlFor="LastName">Last Name</label>
                        </div>

                        <div className="form-outline mb-4">
                          <input type="text" id="userName" className="form-control form-control-lg" onChange={handleData} />
                          <label className="form-label" htmlFor="LastName">User Name</label>
                        </div>
